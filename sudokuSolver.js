function tableToArray(tables) {
    let result = [].reduce.call(tables.rows, function (result, row) {
...
function checkInput(value) {
    let regex = parseInt(value) > 0 && parseInt(value) <= 9;
